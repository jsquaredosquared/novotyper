...
mapq_bedgraph = "/export/home/jeffrey/Documents/novocraft-prototype-sv-genotyper/previous_outputs/HG002/HG002.sv.sorted.bedgraph"  #8 (line in Coconut source)


novotyper = App(help="PROTOTYPE STRUCTURAL VARIANT GENOTYPER USING NOVOALIGN MAPQ")  #11 (line in Coconut source)


@novotyper.command  #14 (line in Coconut source)
def genotype(sv_vcf,  # type: str  #15 (line in Coconut source)
    alts_fasta,  # type: str  #15 (line in Coconut source)
    mapq_bedgraph,  # type: str  #15 (line in Coconut source)
