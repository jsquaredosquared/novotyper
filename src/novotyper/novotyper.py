...
if __name__ == "__main__":  #12 (line in Coconut source)
    vcf_info = gt.extract_info_from_vcf(vcf_path, sample)  #13 (line in Coconut source)
    mapq_bedgraph = gt.read_mapq_bedgraph(bedgraph_file)  #14 (line in Coconut source)

    test_locs = ((list)((map)(_coconut_complex_partial(gt.calculate_mapq, {1: mapq_bedgraph}, 2, ()), (lift(_coconut_comma_op)(gt.get_ref_test_locs, gt.get_alt_test_locs))((gt.get_pass_variants)((_coconut_complex_partial(gt.add_vcf_info_to_test_locs, {1: vcf_info}, 2, ()))((gt.define_alt_test_locs)((gt.join_ref_and_sv_locs)(*(lift(_coconut_comma_op)(gt.extract_ref_locs_of_alts, gt.extract_sv_locs))((gt.read_alts_fasta_descriptions)(fasta_path))))))))))  #16 (line in Coconut source)

    print(*test_locs)  #29 (line in Coconut source)
